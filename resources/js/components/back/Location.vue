...
<script>
    export default {
        ...
        methods: {
            ...
            getData(){
                axios.get('/api/location?page='+this.pagination.current_page)
                .then(response => {
            ...
            searchData(){
                axios.get('/api/search/location/'+this.queryField+'/'+this.query+'?page='+this.pagination.current_page)
            ...
            active(id){
        		...
        		axios.get('/api/location/active/'+id)
                .then(response => {
                    this.getData()
            ...
            unactive(id){
        		...
        		axios.get('/api/location/unactive/'+id)
                .then(response => {
                    this.getData()
            ...
            destory_info(){
                this.form.delete('/api/location/'+this.form.id)
